 ...
 * Word Class to store Default(English) Translations and Miwok Translations
 */
...
public class Word {
    ...
    /** Constant value that represents no audtio was provided for this word */
    ...
    /**
     * Returns whether or not there is an audio resource for this word.
     */
